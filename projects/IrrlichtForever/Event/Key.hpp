...
namespace Irr
{
    enum class Key : irr::u32
    {
        ...
        None = 0xFF,        // Usually no key mapping, but some laptops use it for fn key
        Count = 0x100       // This is not a key, but the amount of keycodes there are.
    };
}
